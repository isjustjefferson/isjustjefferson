...
<!-- Typing SVG -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=58A6FF&center=true&vCenter=true&width=700&lines=Olá%2C+eu+sou+Jefferson+👋;Estudante+de+ADS+no+IFPE;Apaixonado+por+tecnologia+%26+código)](https://git.io/typing-svg)

<br/>

<img src="https://avatars.githubusercontent.com/u/192663509?v=4" width="120" style="border-radius: 50%;" alt="Jefferson Silva" />

<br/>

[![GitHub followers](https://img.shields.io/github/followers/isjustjefferson?label=Followers&style=social)](https://github.com/isjustjefferson)
[![GitHub stars](https://img.shields.io/github/stars/isjustjefferson?label=Stars&style=social)](https://github.com/isjustjefferson)
...
class Jefferson:
    ...
    escola    = "IFPE - Campus Paulista"
    localizacao = "Paulista, Pernambuco 🇧🇷"
    interesses = ["Backend", "Banco de Dados", "Web Dev"]
    atualmente = "Estudando e desenvolvendo projetos acadêmicos"
    curiosidade = "Fã do Boston Celtics 🍀"
```
